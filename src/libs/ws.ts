...
class WSClient {
    ...
    groups?: string[];
    actions: Record<string, (data?: Record<string, unknown>) => Promise<unknown>>;
    listeners: Record<string, { fn?: (...args: unknown[]) => void; filter?: Record<string, unknown> }>;

    constructor(ws: InstanceType<typeof WS>) {
        this.ws = ws;
